...
public class PostServiceImpl implements PostService {
	...
	@Override
	@Transactional(readOnly = true)
	public void paging4Admin(Paging paging, long id, String title,String tags,  int group) {
		List<PostPO> list = postDao.paging4Admin(paging, id, title,tags, group);
